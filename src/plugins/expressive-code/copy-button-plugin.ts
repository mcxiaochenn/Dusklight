...
export function pluginCopyButton() {
	console.log("[COPY-PLUGIN] Loaded");
	return definePlugin({
		name: "Copy Button",
		hooks: {
			postprocessRenderedBlock: ({ renderData }) => {
				console.log("[COPY-PLUGIN] Hook called, blockAst type:", blockAst?.tagName, "children:", blockAst?.children?.length);
				if (!blockAst.children) {
					blockAst.children = [];
				}
					...
					children: [
						{
							type: "element",
							tagName: "div",
							properties: { class: "ec-copy-btn-icon" },
							children: [
								{
									type: "element",
									tagName: "svg",
									properties: {
										...
										class: "ec-copy-btn-icon copy-icon",
									},
									children: [
										{
											type: "element",
								...
								},
								{
									...
									properties: {
										viewBox: "0 -960 960 960",
										xmlns: "http://www.w3.org/2000/svg",
										class: "ec-copy-btn-icon success-icon",
									},
									children: [
										{
											type: "element",
